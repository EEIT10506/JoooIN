...
<%--    		 <c:if test="${memberId ==  }"> --%>
<!--    		  <span class="backButton"> -->
<%--    		   <a href="${pageContext.request.contextPath}/event/participated/${event.eventId}" id="backbutton" class="btn btn-secondary btn-lg backsbutton" role="button" aria-pressed="true">返回活動</a> --%>
<!--    		 </span> -->
<%--    		 </c:if> --%>
   	</h1> 
      <div class="row">
      ...
      <form:form method="POST" modelAttribute="eventReportBean" action="${pageContext.request.contextPath}/event/report/${event.eventId}">
		...
		<div class="form-group">
			...
			<form:input type="hidden" value='${reportBean.reportViolatorId}' path="reportViolatorId" id="reportViolatorId"/>
		</div>
