	...
	<div id="main">
		...
		<form:form method="POST" modelAttribute="groupMainBean" enctype="multipart/form-data">
			<fieldset>
				...
				<form:input path="groupType" type='text' id="groupType"/>
				...
				<form:input type="file" accept="image/*" path="multipartFile" id="multipartFile" onchange="checkImage(this)"></form:input>
